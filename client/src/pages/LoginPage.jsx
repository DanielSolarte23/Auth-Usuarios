          ...
          <div className="border 2xl:py-5 py-3 px-10 rounded-xl  h-[90%] contain shadow-2xl">
            ...
            <form onSubmit={onSubmit} className=" h-[50%]">
              ...
              <div className="h-[20%] flex items-center">
                <button className=" bg-red-700 px-3 w-full h-full py-1 rounded-md hover:bg-red-800 text-xl text-white font-semibold" type="submit">Iniciar Sesión</button>
              </div>
            </form>
            <p className="flex gap-2 text-xl items-center justify-between h-[5%] text-white">
              No tienes una cuenta?<Link to="/register" className="text-red-700 hover:red-800 font-bold">Registrate</Link>
            </p>
            <div className="h-[10%]">
